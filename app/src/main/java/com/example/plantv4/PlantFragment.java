    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(),com.example.plantv4.MyPlantActivity.class );
        ...
        ListView lvPlantAdd = view.findViewById(R.id.lvPlantAdd);
        adapter = new PlantAdapter(getContext(), R.layout.custom_listview, MyPlantActivity.plantHave);
        lvPlantAdd.setAdapter(adapter);
